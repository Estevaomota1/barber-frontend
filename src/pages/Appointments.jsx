...
const styles = {
  ...
  card: { background: '#18181b', border: '0.5px solid #27272a', borderRadius: '12px', padding: '24px', marginBottom: '24px' },
  ...
  cardTitle: { fontSize: '16px', fontWeight: '500', margin: 0, color: '#fff' },
  ...
  select: { background: 'transparent', border: 'none', outline: 'none', color: '#fff', fontSize: '14px', padding: '12px 0', width: '100%', fontFamily: 'inherit', cursor: 'pointer' },
  formActions: { display: 'flex', justifyContent: 'flex-end', marginTop: '8px' },
  btnPrimary: { display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: '#f59e0b', color: '#09090b', border: 'none', borderRadius: '8px', padding: '10px 20px', fontSize: '14px', fontWeight: '600', cursor: 'pointer', boxShadow: '0 4px 12px rgba(245, 158, 11, 0.15)' },
  ...
  filterContainer: { background: 'linear-gradient(135deg, #18181b 0%, #111114 100%)', border: '1px solid #27272a', borderRadius: '16px', padding: '20px 24px', marginBottom: '32px', boxShadow: '0 10px 30px -10px rgba(0,0,0,0.5)' },
  filterHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '24px', flexWrap: 'wrap' },
  filterTitleGroup: { display: 'flex', alignItems: 'center', gap: '16px' },
  filterIconBox: { width: '44px', height: '44px', background: 'rgba(245, 158, 11, 0.1)', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(245, 158, 11, 0.2)' },
  filterTitle: { fontSize: '16px', fontWeight: '600', color: '#fff', margin: 0 },
  ...
  premiumDateInput: { background: '#09090b', border: '1px solid #3f3f46', borderRadius: '10px', color: '#fff', padding: '10px 16px', fontSize: '14px', fontWeight: '500', outline: 'none', cursor: 'pointer', minWidth: '180px', appearance: 'none', WebkitAppearance: 'none' },
  dateChevron: { position: 'absolute', right: '12px', color: '#52525b', pointerEvents: 'none', fontSize: '14px' },
  premiumClearBtn: { background: 'rgba(248, 113, 113, 0.1)', border: '1px solid rgba(248, 113, 113, 0.2)', color: '#f87171', padding: '10px 16px', borderRadius: '10px', fontSize: '13px', fontWeight: '600', cursor: 'pointer', display: 'flex', alignItems: 'center' },
  table: { width: '100%', borderCollapse: 'collapse', textAlign: 'left' },
  th: { fontSize: '12px', textTransform: 'uppercase', color: '#71717a', fontWeight: '600', padding: '12px 16px', letterSpacing: '0.05em' },
  ...
  avatar: { width: '36px', height: '36px', background: '#27272a', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '14px', fontWeight: '600', color: '#f59e0b', border: '0.5px solid #3f3f46' },
  clientName: { fontWeight: '500', color: '#fff' },
  dateTime: { display: 'flex', alignItems: 'center', color: '#a1a1aa' },
  statusSelect: { padding: '4px 12px', borderRadius: '20px', border: 'none', fontSize: '12px', fontWeight: '600', cursor: 'pointer', outline: 'none' },
